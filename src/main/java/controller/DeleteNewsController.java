 ...
 * @author Admin
 */
@WebServlet(name = "DeleteNewsController", urlPatterns = {"/delete"})
public class DeleteNewsController extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = -7687679956677564754L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.deleteNews(Integer.parseInt(pid));
