 ...
 * @author Admin
 */
@WebServlet(name = "AddNewsTypeController", urlPatterns = {"/addNewsType"})
public class AddNewsTypeController extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = -2850840121649026440L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
	        	NewsType n = new NewsType(type);
	            dao.addNewNewsType(n);
