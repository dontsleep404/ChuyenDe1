                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1"><a href="ListController">HOME</a> / NEWS MANAGEMENT</h2>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>NEWS MANAGEMENT <b></b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add News</span></a>
                                <a href="ManagerNewsTypeController" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>News Type Management</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <form action="addNews" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <%
                                    List<NewsType> listC = new NewsTypeDAO().getAllCategory();
                                %>
                                <div class="form-group">
                                    <label>News Type</label>
                                    <select name="newsType" class="form-select" aria-label="Default select example">
                                        <c:forEach items="<%= listC%>" var="o">
                                            <option value="${o.id}">${o.newsType}</option>
                                        </c:forEach>
                                    </select>
                                </div>
...
.catch( error => {
    console.error( error );
                                            ...
                                            function editProduct(param) {
                                                ...
                                                console.log(id);
                                                $.ajax({
                                                    url: "/DigitalNews/EditNewsController",
